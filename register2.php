...
$username_err = "Please enter a username biko.";
} else{
...
$password_err = "Please enter a password right now.";
...
?>
<div class="row card pt-4 m-2 wrapper">
...
<div id="example" class="form-group <?php echo (!empty($confirm_password_err)) ? 'haserror'
: ''; ?>">
